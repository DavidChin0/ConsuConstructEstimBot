...
EXPORT_ETABS_ACERO_DOC = {
    ...
    "paso_a_paso": [
        ...
        "3. En el arbol de tablas, marca ESTAS TRES hojas:",
        "   - Design Data > Steel Frame Design > Steel Frame Design Summary",
        "   - Assignments > Frame Assigns - Summary",
        "   - Analysis Results > Frame Output > Frame Forces  ← NUEVO (autopobla fuerzas en §D-H)",
    ...
    "hojas_requeridas": {
        ...
        "Frame Output - Frame Forces (OPCIONAL — autopobla Pu/Vu/Mu en Hoja §D-H)": [
            "Frame (o UniqueName)",
            "OutputCase (o LoadCase / Combo)",
            "P  — axial [kN]  (+compresion / -tension)",
            "V2 — cortante eje fuerte [kN]",
            "M3 — momento eje fuerte [kN·m]",
        ],
    },
    "notas": [
        "El parser hace JOIN entre las 3 hojas por ID de frame.",
        "Frame Forces: el parser selecciona el combo con mayor |M3| por frame como caso gobernante.",
        "Fuerzas se convierten de kN/kN·m a toneladas/t·m (÷ 9.80665) para la Hoja §D-H.",
